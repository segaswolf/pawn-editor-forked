...
public class TabWorker_Gear : TabWorker<Pawn>
{
    ...
    {
        // FIX #012: Added OnLoad callbacks to refresh pawn graphics after loading gear presets.
        // Without this, melee weapons and loaded apparel are invisible until the pawn is redrawn.
